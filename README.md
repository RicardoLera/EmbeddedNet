...
<p align="center">
<img src="https://render.githubusercontent.com/render/math?math={\displaystyle\   \frac{\partial \hat{I}_{ij}}{\partial I_{ij}} = \frac{1}{\sqrt{\sigma^2 %2B \epsilon}} \qquad   \frac{\partial \sigma^2}{\partial I_{ij}} = \frac{2(I_{ij}-\mu)}{T} \qquad \frac{\partial \mu}{\partial I_{ij}} = \frac{1}{T}   }#gh-light-mode-only">
<img src="https://render.githubusercontent.com/render/math?math={\displaystyle \color{white}\   \frac{\partial \hat{I}_{ij}}{\partial I_{ij}} = \frac{1}{\sqrt{\sigma^2 %2B \epsilon}} \qquad   \frac{\partial \sigma^2}{\partial I_{ij}} = \frac{2(I_{ij}-\mu)}{T} \qquad \frac{\partial \mu}{\partial I_{ij}} = \frac{1}{T}   }#gh-dark-mode-only">
</p>
<p align="center">
<img src="https://render.githubusercontent.com/render/math?math={\displaystyle\   \frac{\partial L}{\partial I_{ij}} = \frac{\partial L}{\partial \hat{I}_{ij}} \frac{1}{\sqrt{\sigma^2 %2B \epsilon}} %2B \frac{\partial L}{\partial \sigma^2} \frac{2(I_{ij}-\mu)}{T} %2B \frac{\partial L}{\partial \mu} \frac{1}{T}   }#gh-light-mode-only">
<img src="https://render.githubusercontent.com/render/math?math={\displaystyle \color{white}\   \frac{\partial L}{\partial I_{ij}} = \frac{\partial L}{\partial \hat{I}_{ij}} \frac{1}{\sqrt{\sigma^2 %2B \epsilon}} %2B \frac{\partial L}{\partial \sigma^2} \frac{2(I_{ij}-\mu)}{T} %2B \frac{\partial L}{\partial \mu} \frac{1}{T}   }#gh-dark-mode-only">
</p>
